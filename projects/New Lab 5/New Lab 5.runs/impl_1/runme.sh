...
HD_PWD='C:/Users/adria/OneDrive/Documents/ECE 316/New Lab 5/New Lab 5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_stopwatch.tcl -notrace
