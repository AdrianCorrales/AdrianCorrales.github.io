...
HD_PWD='C:/Users/adria/OneDrive/Documents/ECE 316/New Lab 5/New Lab 5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_stopwatch.tcl
